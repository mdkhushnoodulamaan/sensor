...
class DataTransformation:
    ...
    def initiate_data_transformation(self):
        """
        Method Name : initiate_data_transforamtion
        Description : This method initiate the data transforamtion component for the pipeline
        ...
        try:
            ...
            preprocessor_path =self.data_transforamtion_config.transformed_object_file_path
