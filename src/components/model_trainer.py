...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            logging.info(f"Splitting training and testing and testing input and target feature")
            ...
            logging.info(f"Extract model config file path")
            ...
            logging.info(f"Extract model model config file path")
